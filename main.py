...
#INFLATIONARY COMMODITIES
    ...
    #oil
oil = quandl.get('CHRIS/ICE_T1', start_date = start, end_date = end, api_key = api_key)
# web.DataReader('CHRIS/ICE_T1' ,'quandl',  start, end, api_key = api_key)
oil['Symbol'] = 'CL'
    #oil weekly data
...
#gold = web.DataReader('CHRIS/CME_GC1','quandl',  start, end, api_key = api_key)
gold['Symbol'] = 'GC'
...
#EQUITIES
    ...
    #NASDAQ
nsdq = quandl.get('CHRIS/CME_NQ1', start_date = start, end_date = end, api_key = api_key)
nsdq['Symbol'] = 'NASDAQ'
    #nsdq weekly data
...
#############################################################################################
    #SP500
es = quandl.get('CHRIS/CME_ES1', start_date = start, end_date = end, api_key = api_key)
es['Symbol'] = 'SP500'
    #SP500 Weekly
es_weekly = DataFrame()
...
############################################################################
    ...
    #Curve Data VX1-VX5
vx1 = quandl.get('CHRIS/CBOE_VX1', start_date = start, end_date = end)
vx1['Symbol'] = 'VX1'
vx1.to_csv(write_path+'vx1.csv')
#######################################################################
vx2 = quandl.get('CHRIS/CBOE_VX2', start_date = start, end_date = end)
vx2['Symbol'] = 'VX2'
vx2.to_csv(write_path+'vx2.csv')
#######################################################################
vx3 = quandl.get('CHRIS/CBOE_VX3', start_date = start, end_date = end)
vx3['Symbol'] = 'VX3'
vx3.to_csv(write_path+'vx3.csv')
#######################################################################
vx4 = quandl.get('CHRIS/CBOE_VX4', start_date = start, end_date = end)
vx4['Symbol'] = 'VX4'
vx4.to_csv(write_path+'vx4.csv')
#######################################################################
vx5 = quandl.get('CHRIS/CBOE_VX5', start_date = start, end_date = end)
vx5['Symbol'] = 'VX5'
...
#CURRENCIES
    #USD
dollar = quandl.get('CHRIS/ICE_DX1', start_date=start,end_date=end)
dollar['Symbol'] = 'USD'
    #USD WEEKLY
...
#######################################################################
#FIXED INCOME
two_year = quandl.get('FRED/DGS2',start= start,end=end)
two_year['Symbol'] = '2YR'
#######################################################################
ten_year = quandl.get('FRED/DGS10',start= start,end=end)
ten_year['Symbol'] = '10YR'
#######################################################################
#######################################################################
#ECONOMIC INDICATORS
unemployment = quandl.get('FRED/UNEMPLOY', start = start, end = end)
#######################################################################
